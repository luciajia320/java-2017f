...
![](http://yp.njuics.cn:7911/Java2D.jpeg)<!-- .element height="60%" width="60%" -->

---

## JAVA GUI......过时了吗？

![](http://yp.njuics.cn:7911/SwingSet.jpeg)<!-- .element height="60%" width="60%" -->

---

## JAVA GUI......过时了吗？

![](http://yp.njuics.cn:7911/minecraft.jpg)<!-- .element height="60%" width="60%" -->
...
![](http://yp.njuics.cn:7911/SwingAWT.jpeg)<!-- .element height="60%" width="60%" -->
...
![](http://yp.njuics.cn:7911/GuiHierarchy.jpeg)<!-- .element height="60%" width="60%" -->

---

## Container Classes

![](http://yp.njuics.cn:7911/ContainerClasses.jpeg)<!-- .element height="60%" width="60%" -->

---

## GUI Helper Classes

![](http://yp.njuics.cn:7911/HelperClasses.jpeg)<!-- .element height="60%" width="60%" -->

---

## Swing GUI Components

![](http://yp.njuics.cn:7911/SwingGUI.jpeg)<!-- .element height="60%" width="60%" -->
...
![](http://yp.njuics.cn:7911/EventClasses.jpeg)<!-- .element height="60%" width="60%" -->

---

## 组件和事件类型

![](http://yp.njuics.cn:7911/CompEvents.jpeg)<!-- .element height="60%" width="60%" -->
...
![](http://yp.njuics.cn:7911/Listeners.jpeg)<!-- .element height="50%" width="50%" -->

---

## Delegation Model

![](http://yp.njuics.cn:7911/DEM.png)<!-- .element height="50%" width="50%" -->
...
![](http://yp.njuics.cn:7911/DelegationAdapter.jpeg)<!-- .element height="60%" width="60%" -->
...
![](http://yp.njuics.cn:7911/Containers2.jpeg)<!-- .element height="60%" width="60%" -->

---

## 示例: Containers (special)

![](http://yp.njuics.cn:7911/Containers3.jpeg)<!-- .element height="60%" width="60%" -->

---

## 示例: Basic Controls

![](http://yp.njuics.cn:7911/BasicControls.jpeg)<!-- .element height="60%" width="60%" -->

---

## 示例: Uneditable Displays

![](http://yp.njuics.cn:7911/Uneditable.jpeg)<!-- .element height="60%" width="60%" -->

---

## 示例: Editable Formatted Displays

![](http://yp.njuics.cn:7911/Editable.jpeg)<!-- .element height="60%" width="60%" -->
...
![](http://yp.njuics.cn:7911/Layout.jpeg)<!-- .element height="60%" width="60%" -->
